...
line(spring_rectified_surface, (25, 50),
        (25, 50 - spring_step_rectified))
x_current = 25, y_current = 50 - spring_step_rectified
for i in range(8):
    line(spring_rectified_surface, (x_current, y_current), 
...
line(spring_coiled_surface, (25, 50),
        (25, 50 - spring_step_rectified))
x_current = 25, y_current = 50 - spring_step_rectified
for i in range(8):
    line(spring_coiled_surface, (x_current, y_current), 
